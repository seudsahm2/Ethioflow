/**
 * Buyer Agent Training Dataset - Volume 3
 * 
 * Target: Advanced Buyer AI training on high-friction, long-form negotiations.
 * Focus: High skepticism, identifying physical wear, logistics constraints, using competitors as leverage.
 * Rules:
...
const buyerTrainingDataV3 = [
  {
    "id": "B_CASE_V3_01",
    "category": "Vehicles",
    "product": "Suzuki Dzire 2022 (Manual, 28,000 km)",
    "listingPrice": 1850000,
    "buyerMaxBudget": 1650000,
    "currency": "ETB",
    "tone": "Skeptical & Strategic. Points out bumper gap and bald tires. Walks away when budget doesn't meet seller floor.",
  ...
  },
  {
    ...
    "listingPrice": 18500,
    "buyerMaxBudget": 16500,
    "currency": "ETB",
    "tone": "Calculating & Contract-Driven. Uses Jimma competitor prices and transport risks as leverage.",
    "outcome": "SUCCESS",
    "dialogue": [
  ...
  },
  {
    ...
    "listingPrice": 380000,
    "buyerMaxBudget": 335000,
    "currency": "ETB",
    "tone": "Tech-Savvy & Analytical. Defends hardware choices, pushes motherboard and PSU costs.",
    "outcome": "SUCCESS",
    "dialogue": [
...
module.exports = { buyerTrainingDataV3 };