/**
 * Buyer Agent Training Dataset - Volume 4
 * 
 * Target: Advanced Buyer AI training on high-friction, long-form negotiations.
 * Focus: High skepticism, identifying logistics constraints, using competitors as leverage, strict budget protection.
 * Rules:
 *   - Maximize discounts while strictly protecting the secret budget cap.
 *   - Buyer opens low (60-70% of listing price) with a concrete justification.
 *   - Raises slowly (2-4% per turn) only when seller concedes or after deadlock.
 *   - End with [DEAL_ACCEPTED] on success, or walk away cleanly on failure.
 */

const buyerTrainingDataV4 = [
  {
    "id": "B_CASE_V4_01",
    "category": "Real Estate / Agriculture",
    "product": "5-Hectare Farm Land Lease in Sululta (Greenhouse ready)",
    "listingPrice": 120000,
    "buyerMaxBudget": 100000,
    "currency": "ETB/month",
    "tone": "Determined & Skeptical. Pushes road and electricity issues, walks away when landlord floor exceeds budget.",
  ...
  },
  {
    ...
    "buyerMaxBudget": 3850000,
    "currency": "ETB",
    "tone": "Shrewd & Gritty. Focuses on bald tires, chassis welding, and injector pump issues, raises slowly to close.",
    "outcome": "SUCCESS",
    "dialogue": [
  ...
  },
  {
    ...
    "listingPrice": 16500,
    "buyerMaxBudget": 15200,
    "currency": "ETB/quintal",
    "tone": "Calculating & Bulk-Focused. Pushes sand/dust purity issues, FSR truck costs, and Dejen checkpost delays.",
    "outcome": "SUCCESS",
    "dialogue": [
...
module.exports = { buyerTrainingDataV4 };